...
while leaving elements that _aren't_ descendants of that element unstyled.
...
so if you're feeling adventurous you can even try combining a type _and_ class selector for the descendant combinator.
